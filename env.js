...
const BUNDLE_ID = 'com.furiganahelper'; // ios bundle id
const PACKAGE = 'com.furiganahelper'; // android package name
const NAME = 'furigana-helper'; // app name
const EXPO_ACCOUNT_OWNER = 'garymur'; // expo account owner
const EAS_PROJECT_ID = '94f2f869-4229-4b24-a760-335686e56fc2'; // eas project id
const SCHEME = 'furigana-helper'; // app scheme
